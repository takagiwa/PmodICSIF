...
architecture rtl of uart_tx is
    ...
    type TYPE_TX is (STAT_IDLE, STAT_FIRST_PACE, STAT_START_BIT, STAT_TRANSMIT, STAT_PARITY_BIT, STAT_STOP_BIT, STAT_WAIT, STAT_TERM);
    signal stat : TYPE_TX;
...
begin
    ...
    uut: uart_rx
        ...
        port map (
            ...
            Debug_rx_pace    => open,
            Debug_rx_sample  => open,
            Debug_rx_d       => open,
            Debug_rx_trigger => open
        );
